...
public abstract class AbstractInfinispanStoreRocksDBIT {
   ...
   protected DefaultCacheManager createCacheManager(int index) {
      String prefix = CommonsTestingUtil.tmpDirectory("server-" + index);
      String baseDir = prefix + separator + "infinispanTempFiles" + separator + this.getClass().getSimpleName() + separator + UUID.randomUUID().toString();
