...
import org.infinispan.server.test.core.ldap.EmptyLdapServer;
import org.infinispan.server.test.core.ldap.RHDS10;
...
public class LdapServerListener implements InfinispanServerListener {
   ...
   public LdapServerListener(String initLDIF, boolean withKdc) {
      ...
      } else if ("rhds10".equals(LDAP_SERVER)) {
         ldapServer = new RHDS10();
      } else if ("empty".equals(LDAP_SERVER)) {
         ldapServer = new EmptyLdapServer();
      } else {
